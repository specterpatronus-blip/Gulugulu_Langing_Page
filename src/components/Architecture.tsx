...
const features = [
  ...
  },
  {
    ...
    gridClass: "md:col-span-12 aspect-[21/7]",
...
const Architecture = () => {
  return (
    <section id="architecture" className="bg-bg py-24 md:py-32">
        ...
        >
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-muted uppercase tracking-[0.3em]">Cómo Funciona</span>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6">
          {features.map((feature, idx) => (
            ...
            >
              ...
              {/* Hover Content */}
              <div className="absolute inset-0 z-20 opacity-0 group-hover:opacity-100 transition-all duration-500 bg-bg/80 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center">
                <span className="text-sm text-text-primary max-w-sm mb-4">
                  {feature.description}
                </span>
                <div className="relative p-[1.5px] rounded-full overflow-hidden">
                  ...
                  <div className="relative bg-bg px-6 py-3 rounded-full">
              ...
              <div className="absolute bottom-0 left-0 right-0 h-28 z-10 bg-gradient-to-t from-black/80 to-transparent pointer-events-none" />

              {/* Bottom Label — always visible */}
              <div className="absolute bottom-5 left-6 z-20 flex flex-col gap-1">
                <span className="text-[10px] text-white/60 uppercase tracking-[0.2em]">{feature.category}</span>
                <span className="text-xl md:text-2xl font-display italic text-white drop-shadow-md">{feature.title}</span>
              </div>
            </motion.div>
          ))}
        </div>
