...
const WhatIsGulugulu = () => {
  return (
    <section id="what-is" className="bg-bg py-16 sm:py-24 md:py-32 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-5 sm:px-6 md:px-10 lg:px-16 relative z-10">

        {/* Intro Block */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-16 lg:gap-24 items-center mb-20 sm:mb-32">
          <motion.div
          ...
          >
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              ...
              <span className="text-[10px] sm:text-xs text-muted uppercase tracking-[0.2em] sm:tracking-[0.3em]">Concepto Revolucionario</span>
            </div>
            ...
            <p className="text-muted text-base sm:text-lg md:text-xl leading-relaxed mb-4 sm:mb-6">
          ...
          >
            ...
            <div className="rounded-[24px] sm:rounded-[40px] overflow-hidden border border-stroke bg-surface/30 backdrop-blur-md shadow-2xl relative">
        ...
        <div className="text-center mb-10 sm:mb-16">
          <h3 className="text-2xl sm:text-3xl md:text-5xl font-display text-text-primary mb-4 sm:mb-6">
            ¿Por qué <span className="italic">elegirnos?</span>
          </h3>
          <p className="text-muted text-sm sm:text-base max-w-2xl mx-auto px-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {pros.map((pro, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-5 sm:p-8 rounded-[20px] sm:rounded-[32px] bg-surface/20 border border-stroke hover:bg-surface/40 hover:border-accent/30 transition-all duration-500 cursor-default group"
            >
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-accent/10 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 group-hover:bg-accent/20 transition-all duration-500">
                {pro.icon}
              </div>
              <h4 className="text-sm sm:text-lg font-medium text-text-primary mb-2 sm:mb-3 group-hover:text-accent transition-colors">{pro.title}</h4>
              <p className="text-xs sm:text-sm text-muted leading-relaxed">{pro.desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="mt-20 sm:mt-32 p-8 sm:p-12 md:p-20 rounded-[28px] sm:rounded-[50px] bg-surface border border-stroke relative overflow-hidden"
        >
          <div className="absolute inset-0 accent-gradient opacity-5" />
          <div className="relative z-10 max-w-3xl">
            <h3 className="text-2xl sm:text-3xl md:text-5xl font-display text-text-primary mb-6 sm:mb-8 leading-tight">
              Lo que tu institución <span className="italic">estaba buscando</span>
            </h3>
            <p className="text-muted text-sm sm:text-lg mb-8 sm:mb-10">
            ...
            <button
              ...
              className="px-8 sm:px-10 py-4 sm:py-5 rounded-full bg-text-primary text-bg font-medium hover:scale-105 transition-transform text-sm sm:text-base w-full sm:w-auto"
            >
          ...
          <div className="absolute bottom-0 right-0 w-40 sm:w-64 h-40 sm:h-64 opacity-10 pointer-events-none translate-x-12 translate-y-12">
